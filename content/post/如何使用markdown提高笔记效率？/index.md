...
summary: Markdown是一种轻量级的标记语言，由John
  Gruber于2004年创建，现在是世界上最受欢迎的标记语言之一，被广泛应用于撰写笔记、编写文档、发布博客、发送邮件等等。
draft: false
featured: false
image:
  filename: featured
...
恭喜你学完了笔记中最常用的所有命令，我想这应该没有花费你半小时。如果还想了解更多，可以继续学习Markdown内嵌HTML标签（请确保你的编辑器支持）。